  ...
  <div class="navbar navbar-dark bg-dark shadow-sm">
    <div class="container d-flex justify-content-between">
      <a href="#" class="navbar-brand d-flex align-items-center">
        <strong>CSC 1100 - Elements of C++ Programming</strong>
      </a>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-4" id="col3">
            <h3 id="desc">C++ is a middle-level programming language developed by Bjarne Stroustrup starting in 1979 at Bell Labs. C++ runs on a variety of platforms, such as Windows, Mac OS, and the various versions of UNIX. </h3>
        </div>
      </div> 
</footer>
